...
const NoteStateHost=(props)=>{
    ...
    // },[logincheckstate])
    return(
<noteContextSo.Provider value={{logincheck,logincheckstate,totalmessages,setTotalmessages,setLogincheckstate,selectedHome, setSelectedHome,profileHost,setProfileHost,back,setBack,isUploading,setIsUploading}}>
{props.children}
